...
.. image:: /_static/img/06-app/img/paraview_plugin_manager.png
   :alt: tools-manage plugins界面

点击右下角Load New…按钮 

.. image:: /_static/img/06-app/img/paraview_load_new.png
   :alt: Load New…按钮

加载PVGeo_All.py文件： 

.. image:: /_static/img/06-app/img/paraview_pvgeo.png
   :alt: 加载PVGeo_All.py文件

等待几分钟，即可成功加载该插件:

.. image:: /_static/img/06-app/img/paraview_pvgeo_loaded.png
   :alt: 成功加载该插件

此时可在Filters中看到PVGeo的filter:

.. image:: /_static/img/06-app/img/paraview_pvgeo_filters.png
   :alt: PVGeo的filter
...
.. |image1| image:: /_static/img/06-app/img/paraview1.png
.. |image2| image:: /_static/img/06-app/img/paraview2.png
.. |image3| image:: /_static/img/06-app/img/paraview3.png
.. |image4| image:: /_static/img/06-app/img/paraview4.png
