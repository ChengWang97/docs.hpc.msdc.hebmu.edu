...
.. image:: /_static/img/06-app/img/matlab_result.png
...
.. image:: /_static/img/06-app/img/matlab_studio_click.png
...
.. image:: /_static/img/06-app/img/matlab_studio_resources.png

选择完毕后点击Launch按钮即跳转至会话管理界面，该界面会列出近期正在排队、运行或者已完成的studio会话。

等到该会话完成排队，进入Running状态，点击下方 Launch MATLAB 按钮，即可进入MATLAB应用。

.. image:: /_static/img/06-app/img/matlab_studio_session.png

.. image:: /_static/img/06-app/img/matlab_studio_running.png
...
.. image:: /_static/img/06-app/img/matlab_studio_desktop_click.png

.. image:: /_static/img/06-app/img/matlab_studio_desktop_resources.png

除了从思源一号启动远程桌面外，π 超算也支持启动远程桌面，在选定核数的同时可以同时选定平台：

.. image:: /_static/img/06-app/img/matlab_studio_desktop_resources_pi.png
...
.. image:: /_static/img/06-app/img/matlab_studio_desktop_terminal.png
...
.. image:: /_static/img/06-app/img/matlab01.png

选定核数的时候选择思源一号的一张GPU卡：

.. image:: /_static/img/06-app/img/matlab-siyuan-gpu.png

2. 启动GPU版本MATLAB

在窗口中启动终端（terminal），在终端输入 ``module load matlab/r2022a && matlab`` ，即可启动GPU版本matlab。

.. image:: /_static/img/06-app/img/matlab_studio_desktop_gpu_running.png
...
.. image:: /_static/img/06-app/img/matlab_parallel_1.png
...
.. image:: /_static/img/06-app/img/matlab_studio_cluster_profile_manager.png
...
.. image:: /_static/img/06-app/img/matlab_studio_cluster_profile_plugin_setting.png

.. image:: /_static/img/06-app/img/matlab_studio_cluster_profile_plugin_setting_old.png
...
.. image:: /_static/img/06-app/img/matlab_adjust_parpool_gui.png
...
.. image:: /_static/img/06-app/img/matlab_adjust_parpool_cmd.png
...
.. image:: /_static/img/06-app/img/matlab_start_parpool_gui.png
...
.. image:: /_static/img/06-app/img/matlab_parallel_2.png
...
.. image:: /_static/img/06-app/img/matlab_sy_proxy.png
