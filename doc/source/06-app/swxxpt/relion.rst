...
1. 用 ``Import`` 将数据导入流水线，``Movies/mics`` 功能区参数如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/Import.png
     :width: 900px
...
1. 用 ``Motion correction`` 进行运动校正，``I/O`` 及 ``Motion`` 设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/Motion-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/Motion-2.png
     :width: 900px
...
1. 用 ``CTF estimation`` 进行运动校正，``I/O`` 及 ``CTFFIND-4.1`` 设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/CTF-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/CTF-2.png
     :width: 900px
...
1. 用 ``Subset selection`` 创建自动挑选的模板，设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/Subset-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/Subset-2.png
     :width: 900px
...
1. 用 ``Auto-picking`` 自动挑选颗粒，设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/Auto-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/Auto-2.png
     :width: 900px
...
#. 选中运行完的job，``Display`` 设置为 ``autopick.star`` ，查看颗粒挑选结果。
   ...
   .. image:: /_static/img/06-app/img/Relion/Auto-3.png
     :width: 900px
...
1. 用 ``Particle extraction`` 提取颗粒，设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/Extra-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/Extra-2.png
     :width: 900px
...
#. 选中运行完的job，``Display`` 设置为 ``particles.star`` ，查看颗粒提取结果。
   ...
   .. image:: /_static/img/06-app/img/Relion/Extra-3.png
     :width: 900px
...
1. 用 ``2D classification`` 为接下来对所有图像进行自动挑选计算出一个模板，设置如下：
   ...
   .. image:: /_static/img/06-app/img/Relion/2D-1.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/2D-2.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/2D-3.png
     :width: 900px
   .. image:: /_static/img/06-app/img/Relion/2D-4.png
     :width: 900px
...
#. 选中运行完的job，``Display`` 设置为 ``run_it025_optimiser.star`` ，查看颗粒的模板。
   ...
   .. image:: /_static/img/06-app/img/Relion/2D-5.png
     :width: 900px
...
.. |relion| image:: /_static/img/06-app/img/Relion/relion-3.1.3.png
